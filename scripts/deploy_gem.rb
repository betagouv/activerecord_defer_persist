...
commands = <<~BASH.split("\n")
  sed -E -i '' "s/[0-9]+.[0-9]+.[0-9]+/#{version_without_v}/" lib/activerecord_defer_persist/version.rb
  bundle
  git add lib/activerecord_defer_persist/version.rb Gemfile.lock
  git commit -m "release version #{version_with_v}"
  gem build activerecord_defer_persist.gemspec
...
puts "gem push activerecord_defer_persist-#{version_without_v}.gem --otp 123456"
